        ...
        <div className="w-full min-h-screen bg-[#F4FBFF]">
            ...
            <div>
                <div className="dropdown ">
                    <div tabIndex={0} role="button" className="pl-6 m-1 flex items-center gap-4 border-solid border-2 border-[#EAEAEA] rounded shadow bg-[#FFFFFF]  px-8 py-3 "><span className='text-xl font-medium text-black   '>Features</span><FaAngleDown className='text-xl font-medium text-black  '></FaAngleDown></div>
